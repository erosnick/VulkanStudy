...
{
	std::uint32_t baseColorTextureId = 0xffffffff;
	std::uint32_t roughnessTextureId = 0xffffffff;
	std::uint32_t metalnessTextureId = 0xffffffff;
	std::uint32_t alphaMaskTextureId = 0xffffffff; // May be set to 0xffffffff if no alpha mask
	std::uint32_t normalMapTextureId = 0xffffffff; // May be set to 0xffffffff if no normal map
...
BakedModel loadBakedModel(const std::string& path);
