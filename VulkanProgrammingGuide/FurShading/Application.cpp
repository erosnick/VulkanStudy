...
void Application::createGraphicsPipeline()
{
	...
	normalDebugShaderStages[0] = loadShader("shaders/spv/basic.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
	normalDebugShaderStages[1] = loadShader("shaders/spv/basic.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
	normalDebugShaderStages[2] = loadShader("shaders/spv/normaldebug.geom.spv", VK_SHADER_STAGE_GEOMETRY_BIT);
...
void Application::prepareTextureImages()
{
	...
	createTextureImage("textures/12248_Bird_v1_diff.bmp", geometryTextureImage, geometryTextureDeviceMemory, true, geometryMipLevels);
	createTextureImage("textures/12248_Bird_v1_diff.bmp", modelTextureImage, modelTextureImageMemory, true, modelMipLevels);
