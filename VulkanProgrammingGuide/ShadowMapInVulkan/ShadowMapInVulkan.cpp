...
public:
	...
	*/
	...
	void loadAssets()
	{
		...
		materials[1].texture.loadFromFile(getAssetPath() + "textures/gridlines.ktx", VK_FORMAT_R8G8B8A8_UNORM, vulkanDevice, queue);
		...
		models.resize(2);
		models[0].loadFromFile(getAssetPath() + "models/plane.obj", vertexLayout, 1.0f, vulkanDevice, queue);
		models[1].loadFromFile(getAssetPath() + "models/20180310_KickAir8P_UVUnwrapped_Stanford_Bunny.obj", vertexLayout, 2.0f, vulkanDevice, queue);
		//models[2].loadFromFile(getAssetPath() + "models/sphere.obj", vertexLayout, 2.0f, vulkanDevice, queue);
